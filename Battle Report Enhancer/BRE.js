 ...
 *  game compatability: version 17647 8.11
 *  market: en, uk, us, cz, se, gr
...
*   todo:
 ...
 ==== license ====
 *  Copyright (C) 2011  Nick Toby & Artemisia for french translation
...
/*==== script API ====*/
{
    twcheese.compatability = 8.18;
    twcheese.scriptName = 'Battle Report Enhancer';
    ...
    try{
        ...
        switch(game_data.market)
        {
            default:            
                ...
                twcheese.language['buildings'][0] = 'Village Headquarters';
                ...
                twcheese.language['report']['timeSent'] = 'Sent';
                ...
                twcheese.language['report']['Launched'] = 'Launched';
                twcheese.language['report']['Returns'] = 'Returns';
                twcheese.language['report']['Survivors'] = 'Survivors:';
            ...
            case 'fr':
                twcheese.language['buildings'][0] = 'Quartier général';
                twcheese.language['buildings'][1] = 'Caserne';
                twcheese.language['buildings'][2] = 'Écurie';
                twcheese.language['buildings'][3] = 'Atelier';
                twcheese.language['buildings'][4] = 'Église';
                twcheese.language['buildings'][5] = 'Première église';
                twcheese.language['buildings'][6] = 'Académie';
                twcheese.language['buildings'][7] = 'Forge';
                twcheese.language['buildings'][8] = 'Point de ralliement';
                twcheese.language['buildings'][9] = 'Statue';
                twcheese.language['buildings'][10] = 'Marché';
                twcheese.language['buildings'][11] = 'Camp de bois';
                twcheese.language['buildings'][12] = 'Carrière d\'argile';
                twcheese.language['buildings'][13] = 'Mine de fer';
                twcheese.language['buildings'][14] = 'Ferme';
                twcheese.language['buildings'][15] = 'Entrepôt';
                twcheese.language['buildings'][16] = 'Cachette';
                twcheese.language['buildings'][17] = 'Muraille';
                        
                twcheese.language['months'][0] = 'Jan';
                twcheese.language['months'][1] = 'Fev';
                twcheese.language['months'][2] = 'Mar';
                twcheese.language['months'][3] = 'Avr';
                twcheese.language['months'][4] = 'Mai';
                twcheese.language['months'][5] = 'Jun';
                twcheese.language['months'][6] = 'Jul';
                twcheese.language['months'][7] = 'Aut';
                twcheese.language['months'][8] = 'Sep';
                twcheese.language['months'][9] = 'Oct';
                twcheese.language['months'][10] = 'Nov';
                twcheese.language['months'][11] = 'Dec';
                
                twcheese.language['report']['catDamage'] = 'Dégâts par catapultes :';
                twcheese.language['report']['ramDamage'] = 'Dégâts par béliers :';
                twcheese.language['report']['farmAssistant'] = 'Ressources possibles :';
                twcheese.language['report']['haul'] = 'Butin :';
                twcheese.language['report']['loyalty'] = 'Loyauté :';
                twcheese.language['report']['timeSent'] = 'Envoyé';
                twcheese.language['report']['unitsInTransit'] = 'Les troupes du défenseur qui étaient en campagne';
                twcheese.language['report']['deletedPlayer'] = '(supprimé)';
                twcheese.language['report']['unread'] = '(nouveau)';
                
                twcheese.language['report']['Launched'] = 'Départ';
                twcheese.language['report']['Returns'] = 'Retour';
                twcheese.language['report']['Survivors'] = 'Survivants :';
                
                twcheese.language['twcheese']['Building'] = 'Bâtiments :';
                twcheese.language['twcheese']['Help'] = 'Aide';
                twcheese.language['twcheese']['noReportsSelected'] = 'Aucun rapport selectionné !';
                break;
...
/**
    ...
    function twcheese_getPlayerInfo(playerCell)
    {
        ...
        else
        {
            ...
            //player[0] = playerLink.href.substring(playerLink.href.indexOf('&id=') + 4);
        ...
        try
        {
            ...
            this.getBuildingLevels = function()
            {
                if(this.getEspionageLevel()[0] >= 2)
                {
                    ...
                    //var buildingsStringSplit = this.espionageTable.getElementsByTagName('td')[1+this.getEspionageLevel()[1]].innerHTML.toLowerCase().split('br');
                    var buildingsStringSplit = this.espionageTable.getElementsByTagName('td')[1+this.getEspionageLevel()[1]].innerHTML.split('br');
                    for(i = 0; i < buildingsStringSplit.length; i++)
                    {
                        for(n = 0; n < 18; n++)
                        {
                            //if(buildingsStringSplit[i].search(buildingNames[n]) != -1)
                            if(buildingsStringSplit[i].search(twcheese.language['buildings'][n]) != -1)
                            {
                                buildingLevels[n] = Number(buildingsStringSplit[i].substring(buildingsStringSplit[i].indexOf('(') + 7, buildingsStringSplit[i].indexOf(')')));
                            }
                        }
                        
                        /*== differenetiate between church and first church ==*/
                            if(buildingLevels[5] > 0)
                            {
                                buildingLevels[4] = 0;
                            }
                    }       
            ...
            /**
             * @return  espionageLevel:Array(level:Number,farmAssistant:Number)
             *-------- level -------------
             * value    significance
             * 0        nothing scouted
             * 1        resources
             ...
             *------ farmAssistant -------------
             * value    significance
             * 0        does not have links for farm assistant
             * 1        has links for farm assistant
             */
            this.getEspionageLevel = function()
            {
                ...
                if(this.espionageTable)
                {
                    ...
                    for(var i=0; i<thElements.length; i++)
                    {
                        if(thElements[i].innerHTML.search(twcheese.language['report']['farmAssistant']) != -1)
                            farmAssist = 1;
                    }
                    
                    if(thElements.length - farmAssist < 3)
                        return new Array(thElements.length - farmAssist, farmAssist);
                    else
                        return new Array(3, farmAssist);
                }
                else
                    return 0;
                }
            ...
            {
                if(this.espionageTable)
                    return twcheese.resElementToNumbers(this.espionageTable.rows[0].cells[1]);
                else
                    return false;
            };
            ...
            this.getSent = function()
            {
                ...
                {
                    if(tdElements[i].innerHTML == twcheese.language['report']['timeSent'])
                    {
                        if(game_data.market == 'cz')
                        {
                            //var targetString = '17.10.12 04:27:57'; //todo: replace with below line
                            var targetString = tdElements[i+1].innerHTML;                           
                        ...
                        else if(game_data.market == 'fr') // addition for the french translation 
                        {
                            var targetString = tdElements[i+1].innerHTML;
                            var sent = new Date(    parseInt(targetString.substring(6,10)),
                                                    parseInt(targetString.substring(3,5)) - 1,
                                                    parseInt(targetString.substring(0,2)),
                                                    parseInt(targetString.substring(11,13)),
                                                    parseInt(targetString.substring(14,16)),
                                                    parseInt(targetString.substring(17,19))
                                                );
                        } /* .fr */
                        else /* .net, .us, .co.uk */
                        {                           
                            ...
                            {
                                case 'Jan':
                                    sent.setMonth(0,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Feb':
                                    sent.setMonth(1,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Mar':
                                    sent.setMonth(2,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Apr':
                                    sent.setMonth(3,sentStrings[1].split(',')[0]);
                                    break;
                                case 'May':
                                    sent.setMonth(4,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Jun':
                                    sent.setMonth(5,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Jul':
                                    sent.setMonth(6,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Aug':
                                    sent.setMonth(7,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Sep':
                                    sent.setMonth(8,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Oct':
                                    sent.setMonth(9,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Nov':
                                    sent.setMonth(10,sentStrings[1].split(',')[0]);
                                    break;
                                case 'Dec':
                                    sent.setMonth(11,sentStrings[1].split(',')[0]);
                                    break;
                            }                           
                        }
            ...
            {
                try{
                if(this.getEspionageLevel()[0] == 3)
                {
                    return twcheese_getTroopCount(this.espionageTable.rows[3+this.getEspionageLevel()[1]].getElementsByTagName('table')[0].rows[1],twcheese_gameConfig);
                }
                else
                    return false;
                }catch(e){alert(e);}
...
/*==== page modifier functions ====*/
    ...
    function twcheese_BattleReportEnhancer(gameDoc,report,gameConfig)
    {
        ...
        this.includeReportTools = function()
        {
            ...
            if(report.espionageLevel[0] >= 1)
            {
                ...
                raiderTable.rows[0].cells[0].innerHTML = '<span align="center"><h2>Pillage</h2></span>';
                raiderTable.insertRow(-1);
                ...
                if(report.espionageLevel[0] >= 2)
                    raiderTable.rows[1].cells[0].innerHTML += '<select id="twcheese_raider_selection" onchange="twcheese_changeRaidMode(gameDoc.getElementById(\'twcheese_raider_selection\').value)"><option value="scouted">piller les ressources éspionnées</option><option value="predicted">piller les ressources prédites</option><option value="periodic">piller réguliérement</option></select>';
                else if(report.espionageLevel >= 1)
                    raiderTable.rows[1].cells[0].innerHTML += '<select id="twcheese_raider_selection" onchange="twcheese_changeRaidMode(gameDoc.getElementById(\'twcheese_raider_selection\').value)"><option value="scouted">piller les ressources éspionnées</option></select>';
                else
                ...
                /*==== rally point link ====*/
                raiderTable.rows[1].cells[0].innerHTML += ' <a href="game.php?village='+ game_data.village.id + twcheese.babyUriComponent +'&screen=place&target='+ report.defenderVillage[2] +'">&raquo; Attaquer</a>';
                
                /*==== haul Bonus ====*/
                raiderTable.rows[1].cells[0].innerHTML += '<br/>Bonus de charge : <input id="twcheese_raider_haulBonus" type="text" size=5 value=0 onchange="twcheese_changeRaidMode(document.getElementById(\'twcheese_raider_selection\').value)"></input>%<br/>';
                ...
                setDefaultButton.innerHTML = 'Sauvegarder la configuration actuelle';
                ...
                if(game_data.market != 'uk') //uk rules forbid filling units into rally point
                {
                    ...
                    raiderScoutTable.rows[0].cells[0].innerHTML = '<img src="'+imagePaths['scout']+'" title="" />';
                    raiderScoutTable.insertRow(-1);
            ...
            if(report.demolition)
            {
                ...
                demolitionTable.rows[0].cells[0].innerHTML = '<span align="center"><h2>Destruction</h2></span>';
            ...
            /*==== renamer div ====*/
                ...
                renamerDiv.innerHTML += ' <img id="twcheese_autoRenameInfo" src="/graphic/questionmark.png?1" width="13" height="13" title="" />';
        ...
        this.includeExtraInformation = function()
        {
            ...
            if(gameDoc.getElementById('attack_info_def_units'))
            {
                ...
                survivorsRow.cells[0].innerHTML = twcheese.language['report']['Survivors'];
            ...
            if(report.espionageLevel[0] >= 2)
            {
                ...
                populationRow.cells[1].innerHTML = 'Bâtiments <b>('+report.populationSummary[0]+')</b><br/>Armée <b>('+report.populationSummary[1]+')</b><br/>';
                if(report.espionageLevel[0] == 3)
                    populationRow.cells[1].innerHTML += 'Idle';
                else
                    populationRow.cells[1].innerHTML += 'Inconnue';
            ...
            if(report.loyalty)
            {
                ...
                loyaltyRow.cells[1].innerHTML += '<br/><span title="">Actuellement : '+report.loyaltyExtra[0]+'</span>';
                loyaltyRow.cells[1].innerHTML += '<br/><span title="">Arrivée : '+report.loyaltyExtra[1]+'</span>';
            }
            ...
            oddRow.insertCell(-1);
            oddRow.cells[1].innerHTML = 'Le défendeur a détruit '+report.opponentsDefeatedSummary[1]+' unités.';
            ...
            odaRow.insertCell(-1);
            odaRow.cells[1].innerHTML = 'L\'attaquant a détruit '+report.opponentsDefeatedSummary[0]+' unités.';
            ...
            launchRow.cells[0].innerHTML = '<span title="">'+twcheese.language['report']['Launched']+'</span>';
            launchRow.insertCell(-1);
            ...
            if(showReturnTime)
            {               
                returnRow.cells[0].innerHTML = '<span title="">'+twcheese.language['report']['Returns']+'</span>';
                returnRow.insertCell(-1);
            ...
            /*==== json representation ====*/
            /*var jsonRow = reportTable.insertRow(5); (removed in french translation)
    ...
    function twcheese_BattleReportsFolderEnhancer(gameDoc)
    {
        ...
        this.populateReportsTable = function()
        {
            for(var i=0; i< this.reports.length; i++)
            {
                ...
                if(report.twcheeseLabel)
                {
                    ...
                    reportsTableBody.rows[i+1].insertCell(-1);
                    if(report.isFeint)
                        reportsTableBody.rows[i+1].cells[cellIndex].innerHTML = '<img title="" style="display:block; margin-left:auto; margin-right:auto" src="graphic/dots/grey.png?1">';
                    cellIndex ++;
                    ...
                    if(report.deadNoble)
                    {
                        if(report.attacker[1] == game_data.player.name)
                            ...
                            reportsTableBody.rows[i+1].cells[cellIndex].innerHTML = '<img src="'+imagePaths['priest']+'" style="display:block; margin-left:auto; margin-right:auto" title=""/>';
                    }
                    cellIndex ++;
        ...
        for(var i=1; i < reportsTable.rows.length-1; i++)
        {
            ...
            var reportIcons = reportsTable.rows[i].cells[0].getElementsByTagName('img');
            ...
            /*==== subject html ====*/
            var subjectNode = reportsTable.rows[i].cells[0];
            subjectNode.removeChild(subjectNode.getElementsByTagName('input')[0]);
        ...
        reportsFolderToolbar.innerHTML += '<table style="border-style:solid; border-width:0px;" class="vis modemenu"><tbody><tr><td id="twcheese_displayConfig_tab" style="border-style:solid; border-width:1px;" onclick="document.getElementById(\'twcheese_reportsFolderToolbar\').toggleDisplayConfig();"><a>Paramètres</a></td><td id="twcheese_export_tab" style="border-style:solid; border-width:1px;" onclick="document.getElementById(\'twcheese_reportsFolderToolbar\').toggleExport();"><a>Exporter</a></td></tr></tbody></table>';
            ...
            reportsFolderExportContainer.rows[0].cells[0].innerHTML += '<textarea rows=10 cols=40 />';
                ...
                exportConfigTable.rows[1].cells[0].innerHTML = '<input type="radio" name="format" checked="true" value="BBCode"/> BBCode <br/><input type="radio" name="format" value="plain_links"/> Liens <br/><input type="radio" name="format" value="html_bookmarks"/> HTML';
                exportConfigTable.rows[1].insertCell(-1);
                exportConfigTable.rows[1].cells[1].innerHTML = '<input type="radio" name="attackingVillage" checked="true" value="currentVillage"/> village actuel<br/><input type="radio" name="attackingVillage" value="originalVillage"/> village d\'origine';
                
                exportConfigTable.insertRow(-1);
                exportConfigTable.rows[2].insertCell(-1);               
                exportConfigTable.rows[2].cells[0].colSpan = 2;
                exportConfigTable.rows[2].cells[0].innerHTML = 'Header: <input type="text" id="twcheese_export_header" value="new cheesy attack group" onclick="if(this.value==\'ajouter un groupe\')this.value=\'\';" />';
                
                exportConfigTable.insertRow(-1);
                exportConfigTable.rows[3].insertCell(-1);
                exportConfigTable.rows[3].cells[0].colSpan = 2;
                exportConfigTable.rows[3].cells[0].innerHTML = '<a href="javascript:document.getElementById(\'twcheese_reportsFolderExport\').exportLinks();" > &raquo; Exporter</a>';
                    ...
                    for(var i=1; i < reportsTable.rows.length; i++)
                    {
                        if(attackingVillage == 'current')
                        {
                            if(reportsTable.rows[i].twcheeseReport.attacker[1] == game_data.player.name)
                                exportString += '\n[url=http://' + document.domain + '/game.php?village=' +game_data.village.id+twcheese.babyUriComponent+'&screen=place&try=confirm&type=same&report_id='+reportsTable.rows[i].twcheeseReport.reportID + '] attaquer de nouveau ' +reportsTable.rows[i].twcheeseReport.reportID+ ' de (' + game_data.village.coord + ') vers ('+reportsTable.rows[i].twcheeseReport.defenderVillage[0] +'|'+reportsTable.rows[i].twcheeseReport.defenderVillage[1] + ')[/url]';
                        }
                        else if(attackingVillage == 'original')
                        {
                            if(reportsTable.rows[i].twcheeseReport.attacker[1] == game_data.player.name && reportsTable.rows[i].twcheeseLabel)
                                exportString += '\n[url=http://' + document.domain + '/game.php?village=' +reportsTable.rows[i].twcheeseReport.attackerVillage[2]+twcheese.babyUriComponent+'&screen=place&try=confirm&type=same&report_id='+reportsTable.rows[i].twcheeseReport.reportID + ']attaquer de nouveau ' +reportsTable.rows[i].twcheeseReport.reportID+ ' de (' + reportsTable.rows[i].twcheeseReport.attackerVillage[0] + '|' + reportsTable.rows[i].twcheeseReport.attackerVillage[1] + ') vers ('+reportsTable.rows[i].twcheeseReport.defenderVillage[0] +'|'+reportsTable.rows[i].twcheeseReport.defenderVillage[1] + ')[/url]';
                        }
                    }
                }
            ...
            reportsFolderSettingsDiv.style.display = 'none';
                ...
                for(var i = 0; i < 19; i++)
                {
                    ...
                    reportsFolderSettingsTable.rows[0].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Lien pour réattaquer';
                    ...
                    reportsFolderSettingsTable.rows[2].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Titre du rapport';
                    
                    /*==== note option ====*/
                    checkboxScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsColumn(4,'note')";
                    reportsFolderSettingsTable.rows[3].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Commentaire';                    
                    
                    /*==== attacker option ====*/
                    checkboxScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsColumn(5,'attacker')";
                    reportsFolderSettingsTable.rows[4].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Attaquant';
                    ...
                    reportsFolderSettingsTable.rows[6].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Village de l\'attaquant';
                    ...
                    reportsFolderSettingsTable.rows[7].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Village du défenceur';
                    
                    /*==== feint option ====*/
                    checkboxScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsColumn(9,'feint')";
                    reportsFolderSettingsTable.rows[8].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Fakes';
                    
                    /*==== deadNoble option ====*/
                    checkboxScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsColumn(10,'deadNoble')";
                    reportsFolderSettingsTable.rows[9].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Noble décédé';
                    
                    /*==== loyalty option ====*/
                    checkboxScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsColumn(11,'loyalty')";
                    reportsFolderSettingsTable.rows[10].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Loyauté';
                    
                    /*==== survivors option ====*/
                    survivorsScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsDefenseColumns()";
                    reportsFolderSettingsTable.rows[11].cells[0].innerHTML += '<input onClick="'+survivorsScript+'" type="checkbox"/>Troupes : défence restante';
                    ...
                    reportsFolderSettingsTable.rows[12].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Ressources : Bois';
                    ...
                    reportsFolderSettingsTable.rows[13].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Ressources : Argile';
                    ...
                    reportsFolderSettingsTable.rows[14].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Ressources : Fer';
                    ...
                    reportsFolderSettingsTable.rows[15].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Ressources : Total';
                    
                    /*==== timeLaunched option ====*/
                    checkboxScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsColumn(46,'timeLaunched')";
                    reportsFolderSettingsTable.rows[16].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Départ';
                    
                    /*==== timeReceived option ====*/
                    checkboxScript = "document.getElementById('twcheese_reportsFolderDisplay').toggleReportsColumn(47,'timeReceived')";
                    reportsFolderSettingsTable.rows[17].cells[0].innerHTML += '<input onClick="'+checkboxScript+'" type="checkbox"/>Reçu';
        ...
        reportsFolderDisplay.style.minWidth = '100px';
            ...
            reportsTableHeaderDiv.style.overflow = 'hidden';
                ...
                reportsTableHeader.rows[0].cells[12].innerHTML = '';
                ...
                /*==== subject header ====*/
                reportsTableHeader.rows[1].appendChild(document.createElement('th'));
                reportsTableHeader.rows[1].cells[cellIndex].innerHTML = 'Titre';
                ...
                /*==== note header ====*/
                reportsTableHeader.rows[1].appendChild(document.createElement('th'));
                reportsTableHeader.rows[1].cells[cellIndex].innerHTML = 'Commentaire';
                ...
                /*==== attacker header ====*/
                reportsTableHeader.rows[1].appendChild(document.createElement('th'));
                reportsTableHeader.rows[1].cells[cellIndex].innerHTML = 'Attaquant';
                ...
                /*==== defender header ====*/
                reportsTableHeader.rows[1].appendChild(document.createElement('th'));
                reportsTableHeader.rows[1].cells[cellIndex].innerHTML = 'Défenseur';
                reportsTableHeader.rows[1].cells[cellIndex].style.width = '150px';
                reportsTableHeader.rows[0].cells[cellIndex].style.width = '150px';
                cellIndex ++;
                ...
                /*==== origin header ====*/
                reportsTableHeader.rows[1].appendChild(document.createElement('th'));
                reportsTableHeader.rows[1].cells[cellIndex].innerHTML = 'Origine';
                ...
                /*==== feint header ====*/
                reportsTableHeader.rows[1].appendChild(document.createElement('th'));
                reportsTableHeader.rows[1].cells[cellIndex].innerHTML = 'Fake';
                reportsTableHeader.rows[1].cells[cellIndex].style.width = '50px';
                reportsTableHeader.rows[0].cells[cellIndex].style.width = '50px';
                cellIndex ++;
                ...
                /*==== loyalty header ====*/
                reportsTableHeader.rows[1].appendChild(document.createElement('th'));
                reportsTableHeader.rows[1].cells[cellIndex].innerHTML = 'Loyauté';
                reportsTableHeader.rows[1].cells[cellIndex].style.width = '50px';
                reportsTableHeader.rows[0].cells[cellIndex].style.width = '50px';
                cellIndex ++;
        ...
        reportsSelectorBar.style.borderWidth = '1px';
            ...
            reportsSelectorBarLabel.innerHTML = 'Selection';
            ...
            /*==== clicky table ====*/
                ...
                /*==== option all ====*/
                selectorClickyTable.rows[0].cells[cellIndex].innerHTML = '<a href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectAll()"> tout </a>';
                ...
                /*==== option none ====*/
                selectorClickyTable.rows[0].cells[cellIndex].innerHTML = '<a href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectNone()"> aucun </a>';
                cellIndex++;
                
                /*==== option new ====*/
                selectorClickyTable.rows[0].cells[cellIndex].innerHTML = '<a href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectNew()"> nouveau </a>';
                selectorClickyTable.rows[0].cells[cellIndex].style.width = '25px';
                selectorClickyTable.rows[0].cells[cellIndex].style.textAlign = 'center';
                cellIndex++;
                
                /*==== option old ====*/
                selectorClickyTable.rows[0].cells[cellIndex].innerHTML = '<a href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectOld()"> ancien </a>';
                selectorClickyTable.rows[0].cells[cellIndex].style.width = '25px';
                selectorClickyTable.rows[0].cells[cellIndex].style.textAlign = 'center';
                cellIndex++;
                ...
                /*==== option cleared ====*/
                selectorClickyTable.rows[0].cells[cellIndex].innerHTML = '<a href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectCleared();"> sans défense </a>';
                selectorClickyTable.rows[0].cells[cellIndex].style.width = '25px';
                cellIndex++;
            ...
            /*==== input table ====*/
                ...
                /*==== option text ====*/
                selectorInputTable.rows[0].cells[cellIndex].innerHTML = '<input id="twcheese_select_text" type="text" size="10" value="contains text" onmousedown="if(this.value == \'text\')this.value=\'\'";> <a title="select text" href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectText(document.getElementById(\'twcheese_select_text\').value);"><span style="display:inline-block; zoom:1; *display:inline; background:url(graphic/bbcodes/bbcodes.png?1) no-repeat -140px 0px; padding-left: 0px; padding-bottom:0px; margin-right: 2px; margin-bottom:3px; width: 20px; height: 20px">&nbsp;</span></a>';
                cellIndex++;
                
                /*==== option attacker ====*/
                selectorInputTable.rows[0].cells[cellIndex].innerHTML = '<input id="twcheese_select_attacker" type="text" size="10" value="attacker" onmousedown="if(this.value == \'attaquant\')this.value=\'\';"> <a title="select attacker" href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectAttacker(document.getElementById(\'twcheese_select_attacker\').value);"><span style="display:inline-block; zoom:1; *display:inline; background:url(graphic/bbcodes/bbcodes.png?1) no-repeat -80px 0px; padding-left: 0px; padding-bottom:0px; margin-right: 2px; margin-bottom:3px; width: 20px; height: 20px">&nbsp;</span></a>';
                cellIndex++;
                
                /*==== option defender ====*/
                selectorInputTable.rows[0].cells[cellIndex].innerHTML = '<input id="twcheese_select_defender" type="text" size="10" value="defender" onmousedown="if(this.value == \'défenceur\')this.value=\'\';"> <a title="select defender" href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectDefender(document.getElementById(\'twcheese_select_defender\').value);"><span style="display:inline-block; zoom:1; *display:inline; background:url(graphic/bbcodes/bbcodes.png?1) no-repeat -80px 0px; padding-left: 0px; padding-bottom:0px; margin-right: 2px; margin-bottom:3px; width: 20px; height: 20px">&nbsp;</span></a>';
                cellIndex++;
                
                /*==== option attackerVillage ====*/
                selectorInputTable.rows[0].cells[cellIndex].innerHTML = '<input id="twcheese_select_attackerVillage" type="text" size="7" value="origin" onmousedown="if(this.value == \'origine\')this.value=\'x|y\';"> <a title="select attacker\'s village" href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectAttackerVillage(document.getElementById(\'twcheese_select_attackerVillage\').value);"><span style="display:inline-block; zoom:1; *display:inline; background:url(graphic/bbcodes/bbcodes.png?1) no-repeat -120px 0px; padding-left: 0px; padding-bottom:0px; margin-right: 2px; margin-bottom:3px; width: 20px; height: 20px">&nbsp;</span></a>';
                cellIndex++;
                
                /*==== option defenderVillage ====*/
                selectorInputTable.rows[0].cells[cellIndex].innerHTML = '<input id="twcheese_select_defenderVillage" type="text" size="7" value="target" onmousedown="if(this.value == \'destination\')this.value=\'x|y\';"> <a title="select defender\'s village" href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').selectDefenderVillage(document.getElementById(\'twcheese_select_defenderVillage\').value);"><span style="display:inline-block; zoom:1; *display:inline; background:url(graphic/bbcodes/bbcodes.png?1) no-repeat -120px 0px; padding-left: 0px; padding-bottom:0px; margin-right: 2px; margin-bottom:3px; width: 20px; height: 20px">&nbsp;</span></a>';
                cellIndex++;
            ...
            /*==== mass rename table ===*/
                ...
                /*==== button cell ====*/               
                massRenameTable.rows[0].cells[cellIndex].innerHTML = '<a href="javascript:document.getElementById(\'twcheese_reportsFolderDisplay\').massRename();">&raquo; Renommer</a> <img src="/graphic/questionmark.png?1" width="13" height="13" title="rename selected reports to twCheese format"> ';
                cellIndex++;
                
                /*==== progressLabel cell ====*/
                massRenameTable.rows[0].cells[cellIndex].innerHTML = ' Avancement : ';
                ...
                /*==== progressCount cell ====*/                
                massRenameTable.rows[0].cells[cellIndex].innerHTML = ' (<span id="twcheese_progress_count">0</span>/<span id="twcheese_progress_count_max">0</span> rapports) ';
...
/*==== calculator functions ====*/
    ...
    function twcheese_calculateDemolition(buildings)
    {
        ...
        var catAmountsChurch = new Array(0,400,500,600);
...
/*==== other functions ====*/
    ...
    /**
     *  Adds the format methode to the Date's vanilia js class - added by Artemisia, from the french community
     *  @param  param:String
     *  @return time:String formated 
     */
    ...
    {
        if (game_data.market == 'fr') { // Addition for the french translation. I'm using a custum API to format the time:Date object
            return time.format("dd/MM/yyyy h:mm:ss");
        }
...
/*==== main ====*/
{
    if(!twcheese_BREinitialized)
    {
        ...
        if (game_data.market == 'fr') { narcismDiv.innerHTML = 'BRE codé par <a href="http://forum.tribalwars.net/member.php?u=28484">cheesasaurus</a> et traduit en français par <a href="http://forum.guerretribale.fr/member.php?27255-artemisia">Artemisia</a>'; } //
        else { narcismDiv.innerHTML = 'BRE created by <a href="http://forum.tribalwars.net/member.php?u=28484">cheesasaurus</a>'; }
    ...
    {
        alert('Ce script doit être utilisé sur :\n1) un rapport de combat\n2) liste des rapports avec le filtre "Attaques"\n3) liste des rapports avec le filtre "Défenses"'); //\n4) a topic in your tribal forum');
    }
}